    ...
    <center>
        <form action="${pageContext.request.contextPath}/checklogin" method="post">
            ...
            <div class="container">
                ...
                <input type="password" name="password" minlength="1" required><br/>
        ...
        <c:choose>
            <c:when test="${doipassthanhcong != ''}">
                <p style="color: #BF0000; font-weight: bold; margin-left: 196px">${doipassthanhcong}</p></br>
            </c:when>
        </c:choose>
