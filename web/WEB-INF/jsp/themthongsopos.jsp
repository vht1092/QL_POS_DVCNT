        ...
        <div class="content-pos" style="height: 850px">            
            <form action="${pageContext.request.contextPath}/checkserinumber" method="get">
                <table style="width: 100%; height: auto;">
                    <tr>
                        <td colspan="1">
                            <a href="danhsachpos.html" class="seri" target="_blank">Serial No<i style="color: red">(Click để xem danh sách POS)</i></a><br/>
                        </td>
                        <td colspan="1">Mã tài sản</td>
                    </tr>
                    <tr>
                        <td colspan="1">
                            <c:choose>
                                <c:when test="${_seri != ''}">
                                    <input id="soseri" name="soseri" value="${_seri}" size="17" placeholder="Serial" required="required"/>
                                </c:when>
                                <c:otherwise>
                                    <input id="soseri" name="soseri" value="" size="17" placeholder="Serial" required="required"/>
                                </c:otherwise>
                            </c:choose>

                            <input id="myform" type="submit" value="Kiểm tra" class="verify"/>
                            <c:choose>
                        ...
                        <td colspan="1">
                            <c:choose>
                                <c:when test="${_mataisan != ''}">
                                    <input name="mataisan" value="${_mataisan}"/>
                                </c:when>
                                <c:otherwise>
                                    <input name="mataisan" value=""/>
                                </c:otherwise>
                            </c:choose>
                        </td>
                    </tr>
            ...
            <form action="${pageContext.request.contextPath}/xulythemthongsopso" method="post">
                <table style="width: 100%; height: auto;">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input name="mcc" required="required" maxlength="4" onkeypress="return keyPressWord(event);"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <input name="hanmucVnd" id="hanmucVnd" onkeypress="return keyPressWord(event);"/>
                        </td>
                        <td colspan="2">
                            <input name="hanmucUsd" id="hanmucUsd" onkeypress="return keyPressWord(event);" disabled/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">TID</td>
                    ...
                    <tr>
                        <td colspan="2">
                            <input name="tid1" id="tid1" value="" maxlength="20" required="required"/>
                        </td>
                        <td colspan="2">
                            <input name="mid1" id="mid1" value="" maxlength="20" required="required" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <input class="disabled" name="maDvcnt" value="${maDvcnt}" size="10" readonly="readonly"/>
                    ...
                    <tr>
                        <td colspan="2">
                            <br/>
                            <input type="submit" value="LƯU THÔNG SỐ" class="submit-pos" readonly="readonly"/>
                            <br/>
                        </td>
                    </tr>
                </table>
            ...
            <form method="post"
                  action="${pageContext.request.contextPath}/fileUploadMapping.do"
