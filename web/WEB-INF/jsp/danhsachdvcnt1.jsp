...
<html>
    ...
    <center>
        <div class="content">
                ...
                <form action="${pageContext.request.contextPath}/searchcombobox" method="get" class="timkiembasic">
                    ...
                    <c:choose>
                        <c:when test="${error != null}">
                            <center>
                                <p></p>
                                <marquee style="font-weight: bold; float: left; color: red" behavior="alternate" width="75%%">${error}</marquee>
                                <p></p>
                            </center>
                        </c:when>
                    </c:choose>
            ...
            <table style="margin-top: 8%; width: 150%; font-size: 13px">
                <tr>
                ...
                <c:forEach items="${lst}" var="p">
                    <c:choose>
                        <c:when test="${(macn == p.cnQuanly && p.statusDvcnt == 1 || p.statusDvcnt == 2 || p.statusDvcnt == 3 || p.statusDvcnt == 6 || p.statusDvcnt == 7 || p.statusDvcnt == 8) && p.statusDuyet == 13}">
                            <tr class="row">
                                <td> <a class="xemthongtinduyet" href="xemthongtinduyet.html?id=${p.maDvcnt}" target="_blank"> ${p.maDvcnt}</a></td>
                                <td>${fn:substring(p.tenDvcntVn, 0, 50)}</td>
                                <td>${p.gpdkkdso}</td>
                                ...
                                <td style="font-size: 13px">
                                    ...
                                    <c:choose>
                                        <c:when test="${groupuser == 1 && (macn == p.cnQuanly) && p.statusDvcnt != 6 && p.statusDvcnt != 7 && p.user1Cn == mauser}">
                                            <div class="dropdown">
                                                <button class="chinhsua">Đ/chỉnh th/tin</button>
                                                <div class="dropdown-content">
                                    ...
                                    <c:choose>
                                        <c:when test="${groupuser == 1 && (macn == p.cnQuanly) && p.statusDvcnt != 6 && p.statusDvcnt != 7 && p.user1Cn == mauser}">
                                            <a href="pagekhoa.html?id=${p.maDvcnt}" target="_blank" class="chinhsua" style="background-color: red">Thu hồi POS</a><br/>
                                        </c:when>
                                    </c:choose>
                                </td>
                                <td>${p.diachiDvcnt}</td>
