...
<html>
    <head>
        ...
        <title>PREVIEW & EXPORT: ĐVCNT LẮP THÊM POS</title>
        ...
        <center>
            <div class="content" id="dvContainer">
                <table class="table1">
                    ...
                    <tr>
                    <center><th colspan="3" style="padding-top: 4%; margin-left: 5%"><center><h3> &nbsp;&nbsp;&nbsp; BẢN MÔ TẢ THÔNG TIN ĐƠN VỊ CHẤP NHẬN THẺ(LẮP THÊM POS)</h3></center></th></center>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3" style="padding-top: 2%"><h3 style="float: left; text-decoration: underline">C. THÔNG TIN POS LẮP ĐẶT THÊM</h3></td>
                    </tr>
                    <%
                        int index = 1;
                    %>
                ...
                <center>
                    ...
                    <table class="table1" style="height: 500px">
                        ...
                        <tr>
                            <td colspan="3" style="padding-top: 8%; padding-bottom: 15%"><center><h3>PHÊ DUYỆT CỦA PHÓ TỔNG GIÁM ĐỐC KHỐI/NGƯỜI ĐƯỢC ỦY QUYỀN</h3></center></td>
                        </tr>
                    </table>
                </center>
            </div>
